...
//	while(debug);
	...
	params.addParameter("CentralMeridian", MArgument_getReal(input[6]));
	params.addParameter("StandardParallel", MArgument_getReal(input[7]));
	params.addParameter("Type", MArgument_getReal(input[8]));
